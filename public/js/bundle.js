...
var displayMap = function displayMap(locations) {
  // 186
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmVyZXRlciIsImEiOiJjazBlYXM3Y3MwMDllM2htc2FydGRiZjZnIn0.5B19_sf3P3_DJNOXtMKLvA';
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, last, email, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You are now signed up!');
              window.setTimeout(function () {
                location.assign('/');
              }, 50);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; //http://127.0.0.1:3000
...
var stripe = Stripe('pk_test_CmSGPBteniyIdpW7GLHQz7yg00KQPm8X11'); //211
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId) //http://127.0.0.1:3000
            );
...
var signupForm = document.querySelector('.form--signup'); //mine

var logOutBtn = document.querySelector('.nav__el--logout'); //191

var userDataForm = document.querySelector('.form-user-data'); //195

var userPasswordForm = document.querySelector('.form-user-password'); //196

var bookBtn = document.getElementById('book-tour'); //211
//deligation
//185, 190
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(firstName, lastName, email, password, confirmPassword);
  });
} //191
